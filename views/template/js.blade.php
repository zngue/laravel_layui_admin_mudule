<script>
    var roleIndexUrl ="{{route('template.index')}}",//列表数据
        roleChangeStatusUrl="{{route('template.status')}}",
        roleDelUrl = "{{route('template.del')}}",
        roleAddUrl = "{{route('template.add')}}",
        roleSaveUrl = "{{route('template.save')}}",
        doAddUrl = "{{route('template.doAdd')}}",
        doSaveUrl="{{route('template.doSave')}}",
        modeName = "模板管理"
</script>
